...
Process {
    ...
    Set-Content -Path "$($env:ProgramData)\Microsoft\UpdateOS\UpdateOS_Updates.ps1.tag" -Value "Installed"
    ...
    $queries | ForEach-Object {
        ...
        ((New-Object -ComObject Microsoft.Update.Session).CreateupdateSearcher().Search($_)).Updates | ForEach-Object {
            ...
            if ($_.Title -notmatch "Preview" -and $_.Categories[0].Name -notmatch "Upgrades") { [void]$WUUpdates.Add($_) }
        }
